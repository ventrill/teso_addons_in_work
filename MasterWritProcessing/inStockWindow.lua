...
function MasterWritProcessing.updateInventoryInfo()
    MWP.scanInventory()
    MWP_inStockWindow:SetHidden(true)
    -- MWP.InStockUnits = MWP.prepareInStockInfo()
    MWP.InStockUnits = MWP.prepareInStockInfoList(nil)
...
function MasterWritProcessing.updateBankInfo()
    MWP.scanBank()
    MWP_inStockWindow:SetHidden(true)
    -- MWP.InStockUnits = MWP.prepareInStockInfo()
    MWP.InStockUnits = MWP.prepareInStockInfoList(nil)
...
function MasterWritProcessing.updateHouseBanksInfo()
    MWP.scanHouseBanks()
    MWP_inStockWindow:SetHidden(true)
    -- MWP.InStockUnits = MWP.prepareInStockInfo()
    MWP.InStockUnits = MWP.prepareInStockInfoList(nil)
...
function MasterWritProcessing.updateAllStoredInfo()
    MWP.scanInventory()
    MWP.scanBank()
    MWP.scanHouseBanks()
    MWP_inStockWindow:SetHidden(true)
